...
def select_action(state):
    ...
    if sample > eps_threshold:
        with torch.no_grad():
            ...
            # The policy_net returns a tensor of shape (1, n_actions) where the value at index i is the expecte
...
play_game(get_policy(policy_net))